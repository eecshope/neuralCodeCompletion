...
# what we exactly use
# revise 01/09, add parent at output
...
outfile = 'output_attention_parent.txt'
...
class PTBModel(object):
  ...
  def __init__(self, is_training, config, input_):
    ...
    inputs = tf.concat([inputsN, inputsT], 2)  ## feed parent at the input
    ...
    loss = tf.contrib.legacy_seq2seq.sequence_loss_by_example([logits], [labels], [new_weights])
